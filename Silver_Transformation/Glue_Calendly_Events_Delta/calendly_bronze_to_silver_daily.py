...
# # -------------------- Args : Initial multi days--------------------
# args = getResolvedOptions(sys.argv, [
#     "JOB_NAME",
#     "RAW_PREFIX",         # e.g. s3://dea-calendly-data/bronze/calendly/webhooks/
...
# -------------------- Args : Daily Incremental--------------------
args = getResolvedOptions(sys.argv, [
    "JOB_NAME",
    "RAW_PREFIX"         # e.g. 3://dea-calendly-data/bronze/calendly/webhooks/
    # removed: "START_DATE", "END_DATE"
])

raw_prefix = args["RAW_PREFIX"].strip()
silver_events_path = "s3://dea-calendly-data/silver/calendly_events"

# -------------------- Compute 'yesterday' and dates list --------------------
yesterday = (date.today() - timedelta(days=1)).strftime("%Y-%m-%d")
DATES = [yesterday]
print(f"[INFO] Will rebuild for yesterday only: {DATES}")
